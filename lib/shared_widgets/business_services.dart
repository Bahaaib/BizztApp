...
class BusinessState extends State<BusinessServicesSection> {
  @override
  Widget build(BuildContext context) {
    return OrientationBuilder(builder: (context, orientation) {
      ...
      return ListView.builder(
          itemCount: TextUtils.businessServicesTitles.length,
              ...
              child: Stack(children: <Widget>[
                ...
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      TextUtils.businessServicesTitles[position],
                      style: TextStyle(
                          fontSize: 40.0,
                          color: Colors.white,
                  ...
                  child: CustomExpansionTile(
                    ...
                    children: <Widget>[
                      Padding(
                          ...
                          child: Text(
                            TextUtils.businessServicesDetails[position],
