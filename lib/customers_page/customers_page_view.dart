...
import 'package:bizzt_app/customers_page/customers_page_viewmodel.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:bizzt_app/utils/text_utils.dart';

class CustomersPageView extends CustomersPageViewModel {
  int _currentPage = 0;
  List colorList = [0xff6ec1e4, 0xffFFFF99, 0xff00FF00, 0xff00FF00, 0xff00FF00, 0xff00FF00];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: <Widget>[
          Center(child: Text('הלקוחות שלנו', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0), ),),
          CarouselSlider(
              height: 300.0,
              initialPage: 0,
  ...
  Widget _buildListItems(BuildContext context, int position, double width) {
    return Center(
        child: Container(width: 200.0,
          ...
          child: Image.asset(TextUtils.customersImages[position]),
        ));
  }
